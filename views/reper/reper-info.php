 ...
 * @Date:   2018-08-28 19:30:15
 * @Last Modified by:   caoyicheng_cd
 * @Last Modified time: 2018-08-28 20:46:25
 */
?>

<div id="contentRepers" class="container" style="width: 100%;">
    <h2>仓库信息<span class="glyphicon glyphicon-fire" aria-hidden="true"></span></h2>
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#newReper">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                新建仓库
            </button>
            <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#searchRepers">
                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                查询仓库
            </button>
        </div>

        <div id="searchRepers" class="col-md-4 collapse" >
            <!-- 查询交易组框 -->
            <form id="formSearch" class="form-horizontal" role="form">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input id="reperId" type="text" class="form-control" placeholder="填写仓库编号">
                </div>
                <div class="input-group input-group-sm">
                    <span class="input-group-addon">仓库名</span>
                    <input id="reperName" type="text" class="form-control" placeholder="填写仓库名">
                </div>
                <div class="input-group input-group-sm">
                    <span class="input-group-addon">负责人</span>
                    <input id="reperMgr" type="text" class="form-control">
                </div>
                <div class="input-group input-group-sm">
                    <span class="input-group-addon">值班人</span>
                    <input id="reperWatcher" type="text" class="form-control">
                </div>
                <div>
                    <button id="btSearchPurchs" class="btn btn-success" type="button" onclick="search_purchs(formSearch.searchStatus, formSearch.reperName, formSearch.reperMgr,formSearch.reperWatcher)">
                        搜一下
                    </button>
                </div>
            </form>
